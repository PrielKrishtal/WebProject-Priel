<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarCover_shop.aspx.cs" Inherits="pages_shop_pages_CarCover_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
     <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >כיסוי רכב</h1>
    <br/>
    <img style="width:400px" src="../../pictures/ShopProd/car_cover.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 75 </h2>
    <br />
     <input type="number" name="quantity" style="width: 100px;
        height: 50px;font-size: 50px;background-color: lightblue;font-family:Aharoni" min="0" max="25" step="1" value="0"/>
     <br/>
    <br />
