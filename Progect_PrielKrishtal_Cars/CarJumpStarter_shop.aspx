<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarJumpStarter_shop.aspx.cs" Inherits="pages_shop_pages_CarJumpStarter_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
    <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni">ערכת התנעה לרכב</h1>
    <br/>
    <img style="width:400px" src="../../pictures/ShopProd/car_jumpstarter.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 200 </h2>
    <br />
