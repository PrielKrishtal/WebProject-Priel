<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SteeringWheelCover_shop.aspx.cs" Inherits="pages_shop_pages_SteeringWheelCover_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
      <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >כיסוי להגה</h1>
    <br/>
    <img style="width:400px"  src="../../pictures/ShopProd/steering_wheel.jpg" />
