<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmellTree_shop.aspx.cs" Inherits="pages_shop_pages_SmellTree_shop" %>
...
<ul>
 ...
 <li><a href="../../MainPage.aspx">בית</a></li>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
      <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >ריחן לרכב</h1>
    <br/>
    <img style="width:400px"  src="../../pictures/ShopProd/car_smell.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 15 </h2>
    <br />
