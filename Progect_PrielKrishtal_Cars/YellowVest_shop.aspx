<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YellowVest_shop.aspx.cs" Inherits="pages_shop_pages_YellowVest_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
   ...
   <h1 style="color:white"> 
    ...
    <br />
      <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >אפוד צהוב</h1>
    <br/>
    <img src="../../pictures/ShopProd/efod.jpg" />
