<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhoneHolder_shop.aspx.cs" Inherits="pages_shop_pages_PhoneHolder_shop" %>
...
<ul>
 ...
 <li><a href="../../MainPage.aspx">בית</a></li>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
      <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >מכשיר אוחז לפלאפון</h1>
    <br/>
    <img src="../../pictures/ShopProd/car_phoneholder.jpg" />
