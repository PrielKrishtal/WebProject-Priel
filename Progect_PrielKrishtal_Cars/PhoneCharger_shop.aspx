<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhoneCharger_shop.aspx.cs" Inherits="pages_shop_pages_PhoneCharger_shop" %>
...
<ul>
 ...
 <li><a href="../../MainPage.aspx">בית</a></li>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br /> 
     <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >מטען לפלאפון</h1>
    <br/>
    <img style="width:400px" src="../../pictures/ShopProd/phone_charger.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 50 </h2>
    <br />
