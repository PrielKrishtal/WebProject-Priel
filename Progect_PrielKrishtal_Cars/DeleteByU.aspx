<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteByU.aspx.cs" Inherits="DeleteByU" %>
  ...
  <li><a href="CarShowcase.aspx">קולקציית הרכבים</a></li>
   ...
   <li><a href="Hidon.aspx">חידון</a></li>
    ...
    <form id="form1" runat="server">
        <br />
        <br />
        <h2 style="color:white;align-content:center">הכנס את שם המשתמש אשר היית מעונין למחוק ואת הסיסמה שלו</h2>
         <h2 style="color:white">שם משתמש </h2><input type="text"  id="uName" name="uName"  style="font-family:Aharoni; width: 129px;"/>
<br />
                <h2 style="color:white">סיסמה </h2><input type="text"  id="Pass" name="Pass"  style="font-family:Aharoni; width: 129px;"/>
<br />
