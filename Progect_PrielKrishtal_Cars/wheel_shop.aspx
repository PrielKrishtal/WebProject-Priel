<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wheel_shop.aspx.cs" Inherits="pages_shop_pages_wheel_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
    <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >גלגלים לרכב</h1>
    <br/>
    <img src="../../pictures/ShopProd/tire1.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 210 </h2>
