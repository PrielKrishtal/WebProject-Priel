<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Carpet_shop.aspx.cs" Inherits="pages_shop_pages_Carpet_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
     <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >ערכת שטיחונים לרכב</h1>
    <br/>
    <img style="width:400px" src="../../pictures/ShopProd/car_carpet.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 275 </h2>
    <br />
