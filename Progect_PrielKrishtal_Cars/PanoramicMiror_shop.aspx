<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PanoramicMiror_shop.aspx.cs" Inherits="pages_shop_pages_PanoramicMiror_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />
    <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >מראה פנורמית</h1>
    <br/>
    <img style="width:400px;height:200px" src="../../pictures/ShopProd/panormaic_miror.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 109 </h2>
    <br />
