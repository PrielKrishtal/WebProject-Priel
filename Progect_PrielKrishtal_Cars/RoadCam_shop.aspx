<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadCam_shop.aspx.cs" Inherits="pages_shop_pages_RoadCam_shop" %>
...
<ul>
 ...
 <li><a href="../../MainPage.aspx">בית</a></li>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
    ...
    <br />    
      <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >מצלמת דרך</h1>
    <br/>
    <img src="../../pictures/ShopProd/car_roadcamera.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 130 </h2>
    <br />
