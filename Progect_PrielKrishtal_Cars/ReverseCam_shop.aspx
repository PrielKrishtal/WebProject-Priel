<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReverseCam_shop.aspx.cs" Inherits="pages_shop_pages_ReverseCam_shop" %>
...
<ul>
  ...
  <li><a href="../CarShowcase.aspx">קולקציית הרכבים</a></li>
   ...
   <h1 style="color:white"> 
    ...
    <br />
      <h1 style="align-content:center;color:white;text-decoration-line:underline;font-family:Aharoni" >מצלמה אחורית</h1>
    <br/>
    <img style="width:400px" src="../../pictures/ShopProd/reverse_camera.jpg" />
     <h2 style="text-align:right;color:white">מחיר: ש"ח 90 </h2>
    <br />
